...
namespace Farm.Tool
{
    public static class ConstString
    {
        ...
        public static string SelectedItemEvent = "SelectedItemEvent";

        public static string SelectedItemAndClickEvent = "SelectedItemAndClickEvent";
        ...
        public static string DoActionAfterMoveEvent = "DoActionAfterMoveEvent";
    }
}
